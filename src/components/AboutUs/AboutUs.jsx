...
export default function AboutUs() {
  ...
  return (
   ...
   <div className={s.us_block}>
      ...
      Together, in the green hills of the Ligurian Appenino, among oak and beech tree forests, they carry out historical renovations, architecture and research projects.</p>
      </div>
  ...
  <div className={s.info_icons_phone}>
    <PhoneOutlined className={s.info_icons}/> 
       <p className={s.ph_buddha}>Tell number: +39 3394530633. </p>
